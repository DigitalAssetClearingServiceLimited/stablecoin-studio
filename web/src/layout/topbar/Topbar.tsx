...
import LOGO_HEDERA from '../../assets/png/DACC-logo-full.png';
	...
	return (
		<>
			<Flex
				...
				zIndex='85'
			>
				<Box minW='80px' textAlign='center' ml='64px' mr='64px'>
					<Image data-testid='topbar-logo' src={LOGO_HEDERA} h='48px' margin='auto' />
				</Box>
